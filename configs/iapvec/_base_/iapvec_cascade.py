work_dir = './work_dirs/iapvec/iapvec-anchor'
default_scope = 'mmdet'
custom_imports = dict(imports=['mmdet.iapvec'], allow_failed_imports=False)
...
hf_sam_pretrain_name = "./pretrained/sam-base"
hf_sam_pretrain_ckpt_path = "./pretrained/sam-base/pytorch_model.bin"
...
model = dict(
    ...
    roi_head=dict(
        type='IAPVecAnchorRoIPromptHead', 
        num_stages=3, 
