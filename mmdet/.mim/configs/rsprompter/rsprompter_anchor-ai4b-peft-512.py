...
work_dir = './work_dirs/rsprompter/rsprompter_anchor-ai4b-peft-512-test2'
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='imgs/test'),
...
test_evaluator = dict(
         ...
         metric=['bbox', 'segm'],
         format_only=False,
         #outfile_prefix='./work_dirs/rsprompter/rsprompter_anchor-ai4b-peft-512-test2/test'
         )  #output json file
