...
work_dir = './work_dirs/rsprompter/rsprompter_query-ai4b-peft-512'
...
#相比原配置文件，整个替换了backbone和neck中的feature aggregator
model = dict(
    ...
    ), #backbone整个都改了，换成MMPretrain中的SAM
    neck=dict(
...
#          metric=['bbox', 'segm'],
#          format_only=False,
#          #outfile_prefix='./work_dirs/rsprompter/rsprompter_query-ifly-peft-512/'
#          )  #output json file
