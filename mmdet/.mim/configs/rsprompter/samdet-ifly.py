...
work_dir = './work_dirs/rsprompter/samdet-ifly'
...
vis_backends = [dict(type='LocalVisBackend'),
                #dict(type='WandbVisBackend', init_kwargs=dict(project='rsprompter-ifly', group='samdet', name='samdet-ifly'))
                ]
visualizer = dict(
...
#          type='CocoMetric',
#          format_only=True,
#          outfile_prefix='./work_dirs/rsprompter/samdet-ifly/test')  #output json file
