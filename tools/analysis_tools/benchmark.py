...
def parse_args():
    ...
    parser.add_argument('--config', default='configs/rsprompter/samseg-maskrcnn-seven-peft-512.py', help='test config file path')
    parser.add_argument('--checkpoint', default='work_dirs/rsprompter/samseg-maskrcnn-seven/best_coco_segm_mAP_epoch_18.pth', help='checkpoint file')
    parser.add_argument(
        '--task',
